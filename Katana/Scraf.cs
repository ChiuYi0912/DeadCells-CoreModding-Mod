...
public class Scraf
{
    ...
    public void AddSprIdToggle()
    {
        ...
        options.addToggleWidget(
            "指定围巾使用的精灵".AsHaxeString(),
            "打开为scarfGray。关闭为capeGray".AsHaxeString(),
            sprIdToggleFunction,
    ...
    internal void AddScarfOption(int scarfIndex)
    {
        ...
        options.addHSVColorWidget(
            "围巾的显示颜色".AsHaxeString(),
            "注：修改后将在下一句生效".AsHaxeString(),
            enabledFunc,
            true,
        ...
        options.addSliderWidget(
            "围巾伸展时的最大长度限制".AsHaxeString(),                                  // 标签文本
